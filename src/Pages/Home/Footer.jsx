  ...
  return (
    <footer className="footer--container">
      <div className="footer--content">
        <h3>
          <span className="content--find">Find Us On</span>
        </h3>
      </div>
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=61563748836269&mibextid=LQQJ4d"
      ...
      <p className="footer--content text-center">Copyright © 2024, SINOX STAR FX LIMITED</p>
  <   div className="footer--social--icon">
         </div>
        </div>
